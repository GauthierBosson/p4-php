...
function afficher_formulaire($jouer = true) // Affiche le formulaire
{
  ...
  $formulaire .= ($niveau == 'facile') ? '<strong><ins>Facile</ins></strong> ' :
    '<a href="index.php?niveau=facile">Facile</a> ';
...
function nb_series($jeu, &$series_j1, &$series_j2, $n = 0) {
